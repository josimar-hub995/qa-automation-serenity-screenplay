...
public final class LiveExecutionProgressListener implements TestExecutionListener {
    ...
    public void testPlanExecutionStarted(TestPlan testPlan) {
        ...
        tagExpression = System.getProperty(
    ...
    private void printProgress(
        ...
        int planned = Math.max(
                total.get() - ignored.get(),
                executed
        );
    ...
    private void printFinalSummary() {
        ...
        if (!summaryPrinted.compareAndSet(
                false,
                true
        )) {
    ...
    private boolean isSelected(
        ...
        return CucumberTagExpression.matches(
                tagExpression,
                tags
        );
    }
